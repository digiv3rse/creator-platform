	...
	theme: {
		extend: {
			colors: {
				...
				tremor: {
					brand: {
						faint: "#E0F4FF", // blue-50
						muted: "#C4E2F3", // blue-200
						subtle: "#99D7F9", // blue-400
						DEFAULT: "#5ABEF5", // blue-500
						emphasis: "#139BE6", // blue-700
						inverted: "#FFFFFF", // white
					},
					background: {
						muted: "#E5E7EA", // gray-50
						subtle: "#CFD1D5", // gray-100
						DEFAULT: "#FFFFFF", // white
						emphasis: "#40464F", // gray-700
					},
					border: {
						DEFAULT: "#EEEEEE", // gray-200
					},
					ring: {
						DEFAULT: "#D5D8DD", // gray-200
					},
					content: {
						subtle: "#AAAFB7", // gray-400
						DEFAULT: "#83878F", // gray-500
						emphasis: "#2F353E", // gray-700
						strong: "#020305", // gray-900
						inverted: "#ffffff", // white
					},
				},
				// dark mode
				"dark-tremor": {
					brand: {
						faint: "#0B2529", // custom
						muted: "#174954", // blue-950
						subtle: "#1E9FAF", // blue-800
						DEFAULT: "#3BE2F6", // blue-500
						emphasis: "#60F0FA", // blue-400
						inverted: "#031211", // gray-950
					},
					background: {
						muted: "#13292B", // custom
						subtle: "#1F3137", // gray-800
						DEFAULT: "#112327", // gray-900
						emphasis: "#D1DADB", // gray-300
					},
					border: {
						DEFAULT: "#1F3437", // gray-800
					},
					ring: {
						DEFAULT: "#1f2937", // gray-800
					},
					content: {
						subtle: "#4B6163", // gray-600
						DEFAULT: "#6B7D80", // gray-600
						emphasis: "#E5EBEB", // gray-200
						strong: "#F9FBFB", // gray-50
